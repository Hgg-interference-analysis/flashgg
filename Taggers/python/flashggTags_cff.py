...
#                                 DiPhotonTag=cms.InputTag('flashggDiPhotons'),
                                 ...
                                 Boundaries     = cms.vdouble(),  #5 categories
                                 ...
                                 Boundaries_pt  = cms.vdouble(15, 21, 31, 47, 77, 3000),  #5 categories
...
#                               Boundaries=cms.vdouble(0.55889473,  0.9087378 ,  0.97044208),
                               #Boundaries = cms.vdouble( 0.553, 0.902, 0.957 ), #before Ruben modifications, this row was the uncommented one
                               Boundaries = cms.vdouble( -1 ), #removed last two categories (Ruben 16/09/2024)
                               SetArbitraryNonGoldMC = cms.bool(False),
                               DropNonGoldData = cms.bool(False),
                               RequireVBFPreselection = cms.bool(True),
                               VBFPreselLeadPtMin = cms.double(30.),
                               VBFPreselSubleadPtMin = cms.double(20.),
