...
if customize.tthTagsOnly:
    ...
    print "HERE Dumpers/workspaceStd.py line 480"
    tagList=[
        #["NOTAG",0],
        #["UntaggedTag",0],
        ["UntaggedTag",10],
...
for tag in tagList:
  ...
  for systlabel in systlabels:
      ...
      if tagName == "UntaggedTag" or tagName == "VBFTag":
           currentVariables += diphoton_variables # if tagname is WHLeptonic, dumps the additional variables...
